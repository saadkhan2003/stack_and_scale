  ...
  return (
    <main className="site-shell">
      ...
      <section className="demo-note">
        ...
        <p>
          Entries marked as demo, example or illustrative are placeholders until
          published CMS content is available.
        </p>
      </section>
      <SiteFooter />
    </main>
      ...
      <article className="detail-page">
        ...
        <div className="detail-body">
          {document ? (
            ...
            <p>
              This is clearly labelled demonstration content, ready to be
