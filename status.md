...
| 14    | Execution plan started                           | Commercial, support and document workflows are next. Provider/legal gates for e-signature, payments, tax, document retention and private files must be decided before production use.                                                                                                                                                                                                             |
