...
| 14    | Storage & Scanning Activated; Code Complete      | Commercial primitives, invoices/payments, accounting exports, and private-file metadata complete. MinIO private S3 object storage and ClamAV malware scanning are activated and healthy in production. Real e-sign provider integration is optional based on business decision. Evidence: `docs/evidence/phase-14/VERIFICATION.md`. |
